...
public class RegionNames {
    ...
    public static final String PLATFORM_YELLOW = "yellow-platform";

    public static final String SPRING_BLUE = "blue-spring";
    public static final String SPRING_RED = "red-spring";
    public static final String SPRING_YELLOW = "yellow-spring";

    public static final String JETPACK_BLUE = "blue-jetpack";
